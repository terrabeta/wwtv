...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        if ($.transition) {
            var L = $.timing.dom;
            if (M.style[L] = f["ease-in-back"][0], !M.style[L])
                for (var O in h) f[O][0] = h[O]
        }
        var T = e.frame = function() {
            ...
            W = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (T(n), e = F(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = F()), this.active = !0, t = this, 1 === u.push(t) && T(n))
                }, e.stop = function() {
                    var e, n, i;
